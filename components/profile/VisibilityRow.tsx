...
export function VisibilityRow({ initiallyPublic }: { initiallyPublic: boolean }) {
  ...
  return (
    <div className="flex items-center gap-2.5 rounded-2xl border-[0.5px] border-hairline bg-white px-3.5 py-3 shadow-raised lg:px-5 lg:py-4">
      ...
      <div className="min-w-0 flex-1">
        <p className="text-caption font-bold text-ink lg:text-body-sm">Visible to other donors</p>
        <p className="text-label text-ink-muted">Show up in Discover search results</p>
      </div>
      <button
        type="button"
        onClick={toggle}
