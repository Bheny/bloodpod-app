    ...
    <div>
      ...
      <div className="px-4 py-3">
        ...
        {loading ? (
          ...
          <div className="mt-4 rounded-2xl bg-white px-6 py-10 text-center">
            <Search className="mx-auto size-7 text-ink-faint" />
            <p className="mt-3 text-sm font-bold text-ink">No donors found.</p>
