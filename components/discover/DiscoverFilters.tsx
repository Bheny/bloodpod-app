  ...
  return (
    <div className="bg-white px-4 py-3">
      ...
      <div className="mt-2.5 flex items-center gap-2">
        ...
        {myCity && city !== myCity && (
          <button
            ...
            className="shrink-0 rounded-full bg-red-light px-3 py-2.5 text-[11px] font-bold text-red"
          >
            Near me
          </button>
        )}
      ...
      <button
        ...
        className={cn(
          "mt-2 rounded-full px-3 py-1.5 text-[11px] font-bold transition-colors",
