  ...
  return (
    <div className="px-4 py-4">
      <div className="rounded-2xl bg-surface p-3">
        <p className="text-[13px] font-extrabold text-ink">{podName}</p>
        <p className="mb-1.5 text-[10px] text-ink-faint">Anyone with this link or code can join</p>

        <div className="rounded-xl border border-[#E5E5EA] bg-white px-2.5 py-2">
          <p className="truncate text-[11px] font-medium text-red">{inviteUrl}</p>
        </div>

        <button
          type="button"
          onClick={handleCopyLink}
          className="mt-2 w-full rounded-full py-2.5 text-[11px] font-bold text-white transition-colors duration-200"
      ...
      <div className="mt-2.5 rounded-2xl bg-surface p-3">
        <p className="text-[13px] font-extrabold text-ink">Your pod code</p>
        <p className="mb-1.5 text-[10px] text-ink-faint">Easier to share out loud or by text</p>
        ...
        <div className="mt-2 flex gap-1.5">
          <button
            ...
            className="flex-1 rounded-full py-2.5 text-[11px] font-bold text-white transition-colors duration-200"
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-full bg-white px-3 text-[11px] font-bold text-ink-mid disabled:opacity-60"
          >
      ...
      <p className="mt-5 text-[11px] font-bold uppercase tracking-wide text-ink-muted">Share via</p>

      <div className="mt-2 flex flex-col gap-1.5">
        <button
          type="button"
          onClick={handleWhatsApp}
          className="flex items-center gap-2.5 rounded-xl bg-white px-2.5 py-2.5 text-left"
        >
          <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#E8F5E9] text-[#25D366]">
            <WhatsAppIcon />
          </span>
          <span>
            <p className="text-[12px] font-bold text-ink">WhatsApp</p>
            <p className="text-[10px] text-ink-muted">Recommended · send to contacts</p>
          </span>
        </button>
        ...
        <button
          ...
          className="flex items-center gap-2.5 rounded-xl bg-white px-2.5 py-2.5 text-left"
        >
          <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-red-light text-red">
            <Mail className="size-4" />
          </span>
          <span>
            <p className="text-[12px] font-bold text-ink">Email invite</p>
            <p className="text-[10px] text-ink-muted">Send a direct invite link</p>
          </span>
        </button>
        ...
        >
          ...
          <span>
            <p className="text-[12px] font-bold text-ink">More options</p>
            <p className="text-[10px] text-ink-muted">X, LinkedIn, SMS</p>
          </span>
        </button>
      </div>
    </div>
