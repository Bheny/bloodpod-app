    ...
    <div className="border-b-[0.5px] border-[#E5E5EA] bg-white px-4 py-4 lg:border-b-0 lg:px-6 lg:py-6">
      <div className="flex items-center gap-2.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="truncate text-[8px] text-ink-faint lg:text-[11px]">bloodpod.gh/pod/{podSlug}</p>
        </div>
        <Link
          href="/pod/settings"
      ...
      <div className="mt-3.5 grid grid-cols-3 gap-2 lg:mt-5 lg:gap-3">
        <div className="rounded-xl bg-surface py-2.5 text-center lg:py-4">
          ...
          <p className="text-[9px] text-ink-muted lg:text-[11px]">Members</p>
        </div>
        <div className="rounded-xl bg-surface py-2.5 text-center lg:py-4">
          <p className="text-base font-extrabold text-red lg:text-[22px]">{strengthScore}%</p>
          <p className="text-[9px] text-ink-muted lg:text-[11px]">Strength</p>
        </div>
        <div className="rounded-xl bg-surface py-2.5 text-center lg:py-4">
          <p className="text-base font-extrabold text-ink lg:text-[22px]">{typesCount}</p>
          <p className="text-[9px] text-ink-muted lg:text-[11px]">Types</p>
        </div>
      </div>
    </div>
  );
